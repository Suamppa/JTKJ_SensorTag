...
void mpu9250_get_data(I2C_Handle *i2c, float *ax, float *ay, float *az, float *gx, float *gy, float *gz) {
	...
	data[0] = ((data[0] | rawData[0]) << 8) | rawData[1];
	data[1] = ((data[1] | rawData[2]) << 8) | rawData[3];
	data[2] = ((data[2] | rawData[4]) << 8) | rawData[5];
	data[3] = ((data[3] | rawData[6]) << 8) | rawData[7];
	data[4] = ((data[4] | rawData[8]) << 8) | rawData[9];
	data[5] = ((data[5] | rawData[10]) << 8) | rawData[11];
	data[6] = ((data[6] | rawData[12]) << 8) | rawData[13];
